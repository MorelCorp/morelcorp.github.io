...
layout: page
title: "Livres"
subheadline: "À lire — et probablement à relire"
header:
...
Les livres ci-dessous méritent tous d'être lus, et probablement relus. Ils ont façonné ma façon de penser les équipes, le leadership et la technologie — dans aucun ordre particulier.

<style>
.book-card { transition: transform 0.2s, box-shadow 0.2s; }
.book-card:hover { transform: translateY(-3px); box-shadow: 0 8px 28px rgba(0,0,0,0.15); }
.book-cover { transition: none; }
.book-title-link { color: #1a202c; text-decoration: none; }
.book-title-link:hover { color: #2563eb; }
</style>
